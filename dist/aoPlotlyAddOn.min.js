...
f.series.baseAggregation,E="1000-01-01",J="1000-01-01",S=Pa(a);E=S.min;J=S.max;f.displayRecessions&&(k.shapes=Cb(b.usRecessions,E,J));l=Db(E,J,l);var M=l[0],ba=l[1];k.xaxis.range=[M,ba];var ea=F.offsetWidth,P=ea;Eb(k,15,35);var U=document.createElement("canvas"),W=f.textAndSpaceToTextRatio,X=k.xaxis.tickfont.family,Y=k.xaxis.tickfont.size,Z=k.margin.l,aa=k.margin.r,R=H.getTicktextAndTickvals(M,ba,W,I,X,Y,P,Z,aa,U);k.xaxis.ticktext=R.ticktext;k.xaxis.tickvals=R.tickvals;var V=M;l=[];f.allowFrequencyResampling&&
